...
def main():
    ...
    print("  * grid-charge <= charge: grid charging is a subset of all charging -- A HINT FOR")
    print("    THE EYE ONLY, and deliberately NOT the shipped guard. registers.py's")
    print("    daily_battery_plausible dropped this ordering: the subset argument needs both")
    print("    counters metered in the same domain, which nothing here establishes. Useful")
    print("    for spotting a misaligned read; not a reason to reject a reading.")
