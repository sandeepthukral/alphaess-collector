...
**nas-observability** stack; this repo provides the datasource, the dashboard and the
error alert rule. A project needs no logging configuration to appear there. See
